...
namespace ESIClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "ESICLient/1.0.3/netstandard2.0";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "ESICLient/1.0.3/netstandard2.0"
        ...
        {
            String report = "C# SDK (ESIClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.7.5\n";
