...
namespace ESIClient.Model
{
    ...
    public partial class GetCorporationsCorporationIdAssets200Ok :  IEquatable<GetCorporationsCorporationIdAssets200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdAssets200Ok(int? typeId = default(int?), int? quantity = default(int?), long? locationId = default(long?), LocationTypeEnum locationType = default(LocationTypeEnum), long? itemId = default(long?), LocationFlagEnum locationFlag = default(LocationFlagEnum), bool? isSingleton = default(bool?))
        {
