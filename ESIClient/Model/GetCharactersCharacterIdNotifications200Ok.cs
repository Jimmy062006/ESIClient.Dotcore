...
namespace ESIClient.Model
{
    ...
    public partial class GetCharactersCharacterIdNotifications200Ok :  IEquatable<GetCharactersCharacterIdNotifications200Ok>, IValidatableObject
    {
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum NotificationTypeMoonminingExtractionStarted for value: notificationTypeMoonminingExtractionStarted
            /// </summary>
        ...
        public GetCharactersCharacterIdNotifications200Ok(long? notificationId = default(long?), TypeEnum type = default(TypeEnum), int? senderId = default(int?), SenderTypeEnum senderType = default(SenderTypeEnum), DateTime? timestamp = default(DateTime?), bool? isRead = default(bool?), string text = default(string))
        {
