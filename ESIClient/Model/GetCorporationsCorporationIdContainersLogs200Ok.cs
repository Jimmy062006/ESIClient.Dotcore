...
namespace ESIClient.Model
{
    ...
    public partial class GetCorporationsCorporationIdContainersLogs200Ok :  IEquatable<GetCorporationsCorporationIdContainersLogs200Ok>, IValidatableObject
    {
        ...
        public enum LocationFlagEnum
        {
            ...
            /// <summary>
            /// Enum HiddenModifers for value: HiddenModifers
            /// </summary>
            [EnumMember(Value = "HiddenModifers")]
            HiddenModifers = 38,
        ...
        public GetCorporationsCorporationIdContainersLogs200Ok(DateTime? loggedAt = default(DateTime?), long? containerId = default(long?), int? containerTypeId = default(int?), int? characterId = default(int?), long? locationId = default(long?), LocationFlagEnum locationFlag = default(LocationFlagEnum), ActionEnum action = default(ActionEnum), PasswordTypeEnum? passwordType = default(PasswordTypeEnum?), int? typeId = default(int?), int? quantity = default(int?), int? oldConfigBitmask = default(int?), int? newConfigBitmask = default(int?))
        {
