...
namespace ESIClient.Model
{
    ...
    public partial class GetCorporationsCorporationIdBlueprints200Ok :  IEquatable<GetCorporationsCorporationIdBlueprints200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdBlueprints200Ok(long? itemId = default(long?), int? typeId = default(int?), long? locationId = default(long?), LocationFlagEnum locationFlag = default(LocationFlagEnum), int? quantity = default(int?), int? timeEfficiency = default(int?), int? materialEfficiency = default(int?), int? runs = default(int?))
        {
