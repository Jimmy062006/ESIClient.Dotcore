...
namespace ESIClient.Model
{
    ...
    public partial class GetCorporationsCorporationIdOrders200Ok :  IEquatable<GetCorporationsCorporationIdOrders200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdOrders200Ok(long? orderId = default(long?), int? typeId = default(int?), int? regionId = default(int?), long? locationId = default(long?), RangeEnum range = default(RangeEnum), bool? isBuyOrder = default(bool?), double? price = default(double?), int? volumeTotal = default(int?), int? volumeRemain = default(int?), DateTime? issued = default(DateTime?), StateEnum state = default(StateEnum), int? minVolume = default(int?), int? walletDivision = default(int?), int? duration = default(int?), double? escrow = default(double?))
        {
            ...
            if (isBuyOrder == null)
            {
                throw new InvalidDataException("isBuyOrder is a required property for GetCorporationsCorporationIdOrders200Ok and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for GetCorporationsCorporationIdOrders200Ok and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            if (minVolume == null)
            {
                throw new InvalidDataException("minVolume is a required property for GetCorporationsCorporationIdOrders200Ok and cannot be null");
            }
            else
            {
            ...
            if (escrow == null)
            {
                throw new InvalidDataException("escrow is a required property for GetCorporationsCorporationIdOrders200Ok and cannot be null");
            }
            else
            {
                this.Escrow = escrow;
